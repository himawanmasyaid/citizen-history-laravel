<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a class="nav-link {{ Request::is('dashboard/vtour') ? 'active' : '' }} " href="/dashboard/vtour"><i class="fas fa-eye"></i> <span>Semua Virtual Tour</span></a></li>
        <li><a class="nav-link" href="/dashboard/vtour/create"><i class="fas fa-eye"></i> <span>Tambah Virtual Tour Baru</span></a></li>
        ...
        <li><a class="nav-link" href="/dashboard/entrepreneurs/create"><i class="fas fa-store"></i> <span>Tambah Entrepreneur Baru</span></a></li>

            ...
            <table class="table table-bordered table-md">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/dashboard/entrepreneurs/{{ $entrepreneur->id }}" class="badge bg-info"><i
                                    class="fas fa-eye"></i></a>
                            <a href="/dashboard/entrepreneurs/{{ $entrepreneur->id }}/edit" class="badge bg-warning"><i
                                    class="fas fa-edit"></i></span></a>
                            <form action="/dashboard/entrepreneurs/{{ $entrepreneur->id }}" method="post"
                                class="d-inline">
                                @method('delete')
                                @csrf
